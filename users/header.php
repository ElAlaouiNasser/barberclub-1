...
<head>
    ...
    <link href="../assets/images/favicon/faviconbarber.png" rel="icon">
                    ...
                    <div class="">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="logo" href="home.php">
                                <img class="logo-light" src="../assets/images/logo/LOGObarber1.png" alt="Hairy Logo">
                                <img class="logo-dark" src="../assets/images/logo/LOGObarber1.png" alt="Hairy Logo">
                            </a>
                        </div>
                        ...
                        <div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                            <ul class="nav navbar-nav nav-pos-right nav-bordered-right snavbar-left">
                                <!-- Home Menu -->
                                <li class="active">
                                    <a href="home.php" class=" menu-item">Acceuil</a>

                                </li>
                                <!-- li end -->
                                <li>
                                    <a href="team.php" class="menu-item">Nos Barbiers</a>

                                </li>
                                <li>
                                    <a href="barberclub.php" class="menu-item">Barber Club</a>
                            ...
                            <div class="module module-cart pull-left">
                                ...
                                <div class="module-content module-box cart-box">
                                    ...
                                    <div class="cart--control">
                                        <a class="btn btn--primary btn--bordered btn--rounded btn--block" href="cart.php">View
                                            Cart & Checkout</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="module module-cart pull-left">
                                <div class="module-icon">
                                    <a class="btn btn--white btn--bordered btn--rounded"
                                        href="reservation.php">Book Online</a>
                                </div>
                            </div>
                            <!-- .module-cart end -->
                        </div>
